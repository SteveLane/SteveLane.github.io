...
&hellip; follows on from [previous post]({%post_url 2014-11-24-tools-of-the-trade%}). (Whatever that link will be)!
...
of this specific difference of `r round(mean(power)*100)`% is underwhelming,
...
`r round(mean(power)*100)`%! So at such low sample sizes, small changes in
